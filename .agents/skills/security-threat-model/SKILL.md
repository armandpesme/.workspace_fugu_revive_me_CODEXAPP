...
description: >-
  Threat modeling ancré sur le dépôt : énumère les frontières de confiance, les
  actifs, les capacités d'attaquant, les chemins d'abus et les mitigations,
  puis rédige un threat model Markdown concis. Déclencher uniquement quand
  l'utilisateur demande explicitement de threat modeler un codebase ou chemin,
  d'énumérer les menaces, ou de faire du threat modeling AppSec. Ne pas
  déclencher pour des résumés d'architecture généraux, du code review, ou du
  design non-sécurité. Compatible GitHub Copilot, OpenCode, Anti-Gravity et
  Codex.
license: MIT
