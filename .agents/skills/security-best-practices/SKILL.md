...
description: >-
  Effectuer des reviews de sécurité spécifiques au langage et framework et
  suggérer des améliorations. Déclencher uniquement quand l'utilisateur demande
  explicitement des conseils de sécurité, un rapport de review sécurité, ou de
  l'aide secure-by-default. Langages supportés : python, javascript/typescript,
  go. Ne pas déclencher pour du code review général, du debugging, ou des tâches
  non-sécurité. Compatible GitHub Copilot, OpenCode, Anti-Gravity et Codex.
license: MIT
