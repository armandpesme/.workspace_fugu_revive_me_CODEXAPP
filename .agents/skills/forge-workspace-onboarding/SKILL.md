...
description: Initialiser une session de travail pour ce workspace Minecraft Forge 1.20.1. Utiliser quand une tache commence, quand le contexte a ete compacte, quand un nouvel agent doit reprendre sans etat, ou avant une modification Forge; lire AGENTS.md, .agent/PLAN.md et les skills locaux, avec README.md seulement si le contexte utilisateur/projet le justifie.
---
...
2. Lire `.agent/PLAN.md` pour l'etat courant, les decisions actives, les risques et la prochaine action.
...
- GitHub, commits, branches, push, pull et backup sont autorises quand la demande humaine les vise explicitement ou via `back-up-github` / `explorer-github`.
...
Avant d'agir, formuler l'hypothese de contexte en une phrase si elle influence la solution. Apres une reprise sans etat, citer la prochaine action concrete issue de `.agent/PLAN.md`.
