---
description: "QA final Forge 1.20.1. Lance les vérifications, rend verdict GO / NO-GO / PENDING avec preuves et risques. Lecture seule mais exécute Gradle."
mode: subagent
permission:
  edit: deny
  bash:
...
2. Vérifier la compilation (`bash` Gradle) **ou** expliquer pourquoi elle n'a pas été lancée.
