...
description: Verifier un changement Forge 1.20.1 avec Gradle dans Codex App. Utiliser apres une modification Java, Gradle, resources, metadata, mixins ou assets; pour lancer .\\gradlew.bat test ou .\\gradlew.bat build depuis project-gradle; pour rapporter clairement les echecs; et pour declencher exee-plan apres un build ou clean build reussi.
---
