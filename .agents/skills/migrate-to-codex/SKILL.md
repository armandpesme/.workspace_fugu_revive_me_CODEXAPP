...
description: >-
  Migrer les fichiers d'instructions, skills, agents et config MCP supportés
  vers les fichiers projet et globaux de Codex. Utiliser quand l'utilisateur
  veut migrer depuis un autre IDE (Cursor, Claude Code, Windsurf, etc.) vers
  Codex, ou consolider des configs multi-IDE. Spécifique à Codex.
license: MIT
compatibility: codex
metadata:
