...
Retirer ou assouplir le garde-fou strict uniquement juste avant clean build/release, apres validation. Noter ce changement dans `.agent/PLAN.md` si un build de livraison reussit.
