...
This project is indexed by GitNexus as **.workspace_fugu_revive_me_CODEXAPP** (1513 symbols, 4022 relationships, 108 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
