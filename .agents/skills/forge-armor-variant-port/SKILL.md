...
1. Read `AGENTS.md`, `README.md`, `.agent/PLAN.md`, and the source mod registry/decompiled model classes.
...
Record source paths, target IDs, model variants, validation commands, JAR path, and residual visual-validation risk in `.agent/PLAN.md`.
